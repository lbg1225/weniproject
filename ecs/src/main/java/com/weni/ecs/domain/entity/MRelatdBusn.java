...
import com.weni.ecs.domain.listener.MRelatdBusnListener;

@Data
@NoArgsConstructor(access = AccessLevel.PROTECTED) // AccessLevel.PUBLIC
@Entity
@EntityListeners(MRelatdBusnListener.class)
@Table(name = "M_RELATD_BUSN") //--관련_업무(Table)
@Schema(description = "관련 업무(Table)")
...
//    @Schema(description = "", nullable = true , defaultValue = "" , example = ""  , allowableValues = {"", ""})
    ...
    @Column(name = "BUSN_NM", length = 100, nullable = false)
    @Schema(description = "업무 명", nullable = false)
    private String busnNm; //--업무_명

    @Column(name = "BUSN_NM_RUS", length = 100, nullable = false)
    @Schema(description = "업무 명 러시아", nullable = false)
    private String busnNmRus; //--업무_명_러시아

    @Column(name = "BUSN_NM_KOR", length = 100, nullable = false)
    @Schema(description = "업무 명 한국", nullable = false)
    private String busnNmKor; //--업무_명_한국
