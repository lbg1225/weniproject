/**
 * SIncidCardTrfcPolDtlTmp Entity 클래스
 *
...
import com.weni.ecs.domain.listener.SIncidCardTrfcPolDtlTmpListener;

@Data
@NoArgsConstructor(access = AccessLevel.PROTECTED) // AccessLevel.PUBLIC
@Entity
@EntityListeners(SIncidCardTrfcPolDtlTmpListener.class)
@Table(name = "S_INCID_CARD_TRFC_POL_DTL_TMP") //--사건_카드_교통_경찰_상세_TMP(Table)
@Schema(description = "사건 카드 교통 경찰 상세 TMP(Table)")
@IdClass(SIncidCardTrfcPolDtlTmpPK.class)
