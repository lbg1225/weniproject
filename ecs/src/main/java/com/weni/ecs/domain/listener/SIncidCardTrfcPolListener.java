/**
 * SIncidCardTrfcPol Entity Listener 클래스
 *
...
@Slf4j
public class SIncidCardTrfcPolListener {
    ...
    //----------------------------------------------------
    @PostLoad
    public void onPostLoad(SIncidCardTrfcPol postData) {
        log.info("onPostLoad : Select후 호출({})" , postData.toString() );
    }

    @PrePersist
    public void onPrePersist(SIncidCardTrfcPol preData) {
        log.info("onPrePersist : Insert전 호출({})" , preData.toString() );
    }

    @PostPersist
    public void onPostPersist(SIncidCardTrfcPol postData) {
        log.info("onPrePersist : Insert후 호출({})" , postData.toString() );
    }

    @PreUpdate
    public void onPreUpdate(SIncidCardTrfcPol preData) {
        log.info("onPreUpdate : Update전 호출({})" , preData.toString() );
    }

    @PostUpdate
    public void onPostUpdate(SIncidCardTrfcPol postData) {
        log.info("onPostUpdate : Update후 호출({})" , postData.toString() );
    }

    @PreRemove
    public void onPreRemove(SIncidCardTrfcPol preData) {
        log.info("onPreRemove  : Delete전 호출({})" , preData.toString() );
    }

    @PostRemove
    public void onPostRemove(SIncidCardTrfcPol postData) {
