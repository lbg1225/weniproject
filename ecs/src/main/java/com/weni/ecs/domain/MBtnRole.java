...
public class MBtnRole {
    ...
    private String btnRoleNmRus; //--null

    @Column(name = "BTN_ROLE_NM_KOR", length = 100, nullable = false)
    private String btnRoleNmKor; //--null
