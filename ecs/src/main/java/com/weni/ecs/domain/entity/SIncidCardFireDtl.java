...
import com.weni.ecs.domain.listener.SIncidCardFireDtlListener;

@Data
@NoArgsConstructor(access = AccessLevel.PROTECTED) // AccessLevel.PUBLIC
@Entity
@EntityListeners(SIncidCardFireDtlListener.class)
@Table(name = "S_INCID_CARD_FIRE_DTL") //--사건_카드_소방_상세(Table)
@Schema(description = "사건 카드 소방 상세(Table)")
@IdClass(SIncidCardFireDtlPK.class)
public class SIncidCardFireDtl implements Serializable {
    @Id //  Integer
