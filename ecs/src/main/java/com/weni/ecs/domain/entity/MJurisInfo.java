...
import com.weni.ecs.domain.listener.MJurisInfoListener;

@Data
@NoArgsConstructor(access = AccessLevel.PROTECTED) // AccessLevel.PUBLIC
@Entity
@EntityListeners(MJurisInfoListener.class)
@Table(name = "M_JURIS_INFO") //--관할_정보(Table)
@Schema(description = "관할 정보(Table)")
...
//    @Schema(description = "", nullable = true , defaultValue = "" , example = ""  , allowableValues = {"", ""})
    ...
    @Builder
    public MJurisInfo(String jurisCode, String jurisNm, String busn, String fstRegpersnId, String finalUptpersnId, Date fstRegTm, Date finalUptTm, String jurisNmKor, String jurisNmRus, Float lgt, Float ltt) {
