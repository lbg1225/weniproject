...
import com.weni.ecs.domain.listener.SDispInfoListener;

@Data
@NoArgsConstructor(access = AccessLevel.PROTECTED) // AccessLevel.PUBLIC
@Entity
@EntityListeners(SDispInfoListener.class)
@Table(name = "S_DISP_INFO") //--출동_정보(Table)
@Schema(description = "출동 정보(Table)")
@IdClass(SDispInfoPK.class)
public class SDispInfo implements Serializable {
    @Id //  Integer
...
//    @Schema(description = "", nullable = true , defaultValue = "" , example = ""  , allowableValues = {"", ""})
    ...
    @Builder
    public SDispInfo(Integer recptNum, Integer dtlSeqNum, Date dispCmdTm, Date dispStrtTm, Date dispCloseTm, Integer mdtDevId, String dispPrcsInspId, String fstRegpersnId, String finalUptpersnId, Date fstRegTm, Date finalUptTm) {
