...
import com.weni.ecs.domain.listener.JUsrMnuListener;

@Data
@NoArgsConstructor(access = AccessLevel.PROTECTED) // AccessLevel.PUBLIC
@Entity
@EntityListeners(JUsrMnuListener.class)
@Table(name = "J_USR_MNU") //--사용자_메뉴(Table)
@Schema(description = "사용자 메뉴(Table)")
@IdClass(JUsrMnuPK.class)
public class JUsrMnu implements Serializable {
    @Id //  String
...
//    @Schema(description = "", nullable = true , defaultValue = "" , example = ""  , allowableValues = {"", ""})
    ...
    @Builder
    public JUsrMnu(String usrId, String mnuId, String qryFlag, String uptFlag, String fstRegpersnId, String finalUptpersnId, Date fstRegTm, Date finalUptTm) {
        this.usrId = usrId;
        this.mnuId = mnuId;
