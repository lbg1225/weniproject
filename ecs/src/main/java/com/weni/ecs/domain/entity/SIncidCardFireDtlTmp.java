/**
 * SIncidCardFireDtlTmp Entity 클래스
 *
...
import com.weni.ecs.domain.listener.SIncidCardFireDtlTmpListener;

@Data
@NoArgsConstructor(access = AccessLevel.PROTECTED) // AccessLevel.PUBLIC
@Entity
@EntityListeners(SIncidCardFireDtlTmpListener.class)
@Table(name = "S_INCID_CARD_FIRE_DTL_TMP") //--사건_카드_소방_상세_TMP(Table)
@Schema(description = "사건 카드 소방 상세 TMP(Table)")
@IdClass(SIncidCardFireDtlTmpPK.class)
public class SIncidCardFireDtlTmp implements Serializable {
    @Id //  Integer
