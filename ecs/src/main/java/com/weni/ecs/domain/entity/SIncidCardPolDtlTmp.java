...
import com.weni.ecs.domain.listener.SIncidCardPolDtlTmpListener;

@Data
@NoArgsConstructor(access = AccessLevel.PROTECTED) // AccessLevel.PUBLIC
@Entity
@EntityListeners(SIncidCardPolDtlTmpListener.class)
@Table(name = "S_INCID_CARD_POL_DTL_TMP") //--사건_카드_경찰_상세_TMP(Table)
@Schema(description = "사건 카드 경찰 상세 TMP(Table)")
@IdClass(SIncidCardPolDtlTmpPK.class)
public class SIncidCardPolDtlTmp implements Serializable {
    @Id //  Integer
